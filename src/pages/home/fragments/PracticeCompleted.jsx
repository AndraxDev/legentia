...
function PracticeCompleted({onNewIntent, flawless, time, mistakesCount, streak}) {
    ...
    return (
        <div id={"complete-screen-root"} className="practice-completed" style={{
            ...
            <h3 className={"practice-completed-title"}>{getLocalizedString("titlePracticeCompleted")}</h3>
            <div className={"analytics-box"}>
                <div style={{
                    ...
                    <div className={"stats-title-container"}>
                        <p className={"stat-title"}>{getLocalizedString("practiceCompetedCombo")}</p>
                    </div>
                ...
                <div style={{
                    ...
                    <div className={"stats-title-container"}>
                        <p className={"stat-title"}>{getLocalizedString("practiceCompetedErrors")}</p>
                    </div>
                ...
                <div style={{
                    ...
                    <div className={"stats-title-container"}>
                        <p className={"stat-title"}>{getLocalizedString("practiceCompetedTime")}</p>
                    </div>
            ...
            <button className={"exercise-button exercise-button-neutral"} onClick={() => {
                onNewIntent("/home/1");
            }}>{getLocalizedString("btnContinue")}</button>
            <div style={{
                opacity: "0",
                transition: "opacity 0.5s",
            }} id={"box-motivational"} className={"motivational-message"}>
                {flawless ? getLocalizedString("practiceMessageFlawless") : getLocalizedString("practiceMessageSomeErrors")}
            </div>
        </div>
    );
}
